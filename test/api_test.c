...
static OapisApi kOsslApis[] = {
    ...
    {
        .api = test_chacha20_poly1305_encrypt_decrypt,
        .cert_type = OAPIS_KEY_TYPE_UNKNOW,
        .msg = "Chacha20-Poly1305 Encrypt/Decrypt",
    },
    {
        .api = test_chacha20_encrypt_decrypt,
        .cert_type = OAPIS_KEY_TYPE_UNKNOW,
    ...
    {
        .api = test_aes_gcm_encrypt_decrypt,
        .cert_type = OAPIS_KEY_TYPE_UNKNOW,
        .msg = "AES GCM Encrypt/Decrypt",
    },
};
